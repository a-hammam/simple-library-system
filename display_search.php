  ...
  background-color: #333;
    ...
    <table border="2" align="center" cellpadding="5" cellspacing="5">
        ...
        <tr>
            ...
            <td><a href="delete.php?id=<?php echo $row['ISBN']; ?>" style="color:blue;">Delete</a></td>
            <td><a href="update_book.php?id=<?php echo $row['ISBN']; ?>" style="color:blue;">Update</a></td>
    ...
    <center>
   <h2> <a href="enter_login.php"> Home </a></h2>
    </center>
    </body>
</html>