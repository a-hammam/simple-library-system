...
<style>
    ...
    <form action = "display_search.php" method="get" onsubmit="return validateForm()" name="myForm">
        ...
        <br></br>
        <input id="aa" type="submit" value="Search">
        <input id="aa" type="reset" value="Reset">
        </center>
        <br>
        </form>

        <center><h2><a href="display_all.php">List All Books
        </a></h2></center>
    </body>
</html>