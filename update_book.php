...
<body bgcolor="87ceeb">
   ...
   $old_isbn=  $_GET['id'];
    ...
    <br><br>
   <center><h2>update Book details of id : <?php echo $old_isbn ?></h2></center> 

   
    <!--Once the form is submitted, all the form data is forwarded to InsertBooks.php -->

    
    <form action="updated.php?id=<?php echo $old_isbn ?>" method="post"onsubmit="return validateForm()" name="myForm">
        ...
        <table border="2" align="center" cellpadding="5" cellspacing="5">
            ...
            <td></td>
            <td>
            <input id="aa" type="submit" value="Update Book">
